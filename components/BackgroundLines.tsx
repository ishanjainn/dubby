...
export default function BackgroundLines() {
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-[1]">
      ...
      >
        {/* Subtle olive lines - very low opacity */}
        <motion.path 
          d="M-100 80 Q 200 20, 500 120 Q 800 220, 1100 100" 
          stroke="rgba(140, 135, 100, 0.25)" strokeWidth="1" fill="none"
          animate={{ d: [
        ...
        <motion.path 
          ...
          stroke="rgba(140, 135, 100, 0.22)" strokeWidth="1" fill="none"
          animate={{ d: [
        ...
        <motion.path 
          ...
          stroke="rgba(140, 135, 100, 0.23)" strokeWidth="1" fill="none"
          animate={{ d: [
        ...
        <motion.path 
          ...
          stroke="rgba(140, 135, 100, 0.2)" strokeWidth="1" fill="none"
          animate={{ d: [
        ...
        <motion.path 
          ...
          stroke="rgba(140, 135, 100, 0.18)" strokeWidth="1" fill="none"
          animate={{ d: [
